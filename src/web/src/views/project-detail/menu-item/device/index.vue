<template>
    <div>
      <div>
        ...
        <el-button v-if="canAdd" v-permission="['ROLE_GLOBAL_DEVM']" type="primary" @click="openAddDeviceDialog">
        ...
        >
          ...
          >
            <template slot-scope="{row}">
              ...
              <span v-else>损坏</span>
              <el-button v-if="!row.isReturned" type="text" size="mini" @click="updateDeviceCondition(row)">
      ...
      >
        ...
        <el-button @click="addDeviceDialog.show = false">取 消</el-button>
